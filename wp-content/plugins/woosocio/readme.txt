...
<blockquote>
    <p>
        <strong>Post and Widget For Facebook</strong>
    </p>
</blockquote>
...
<blockquote>
  <p>
    <a href="https://wordpress.org/plugins/gs-facebook-comments/" target="_new">WP Facebook Comments</a> | <a href="https://wordpress.org/plugins/wp-instagram-post/" target="_new">WP Instagram Post</a> | <a href="https://wordpress.org/plugins/wootweet/" target="_new">WP Twitter Post (WooTweet)</a>
  </p>
</blockquote>
...
* Fix:    Error after changing Facebook App.
* Fix:    Blank login page issue.
* Fix:    Refresh login page issue after login.
...
* New:    Shared connection. (All users can use same Facebook connection)
* Modify: Enhanced performance. Fast posting. No more posting delay.
* Fix:    Error after changing Facebook App.
* Modify: Better performance.
